...
$(document).ready(function () {
    ...
    $('.task').on('click', () => {
        $('.task').addClass('onselect');
        $('.home').removeClass('onselect');
        $('.invite').removeClass('onselect');
        $('.list-boost').removeClass('onselect');
    ...
    $('.invite').on('click', () => {
        $('.invite').addClass('onselect');
        $('.home').removeClass('onselect');
        $('.task').removeClass('onselect');
        $('.list-boost').removeClass('onselect');
        $('.conthome').removeClass('d-flex');
        $('.conthome').addClass('hide');
